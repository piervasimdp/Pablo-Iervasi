...
const SocialIcon: React.FC<{ href: string, children: React.ReactNode }> = ({ href, children }) => (
    <a href={href} target="_blank" rel="noopener noreferrer" className="text-f4f9fb hover:text-66c7d9 transition-colors duration-300">
        {children}
    </a>
);
...
const Footer: React.FC = () => {
    return (
        <footer id="footer" className="bg-002f4b text-f4f9fb">
            <div className="container mx-auto px-6 py-8 flex flex-col md:flex-row justify-between items-center text-center md:text-left">
                <div className="flex items-center gap-4 mb-6 md:mb-0">
                    <Logo className="h-12 w-12" />
                    <div>
                        <p className="font-bold font-['Montserrat',_sans-serif]">Observatorio de Orientación Vocacional</p>
                        <p className="text-sm text-gray-300">© 2025 – Mar del Plata – Todos los derechos reservados.</p>
                    </div>
                </div>
